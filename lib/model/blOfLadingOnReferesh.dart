...
class BlOfLadingOnReferesh {
  BlOfLadingOnReferesh({
      String? br, 
      String? etd, 
      String? fpod, 
      String? blact, 
  ...
  BlOfLadingOnReferesh.fromJson(dynamic json) {
    _br = json['Br'];
    _etd = json['ETD'];
    _fpod = json['FPOD'];
    _blact = json['blact'];
  ...
  String? _sailing;
  String? _vessel;
BlOfLadingOnReferesh copyWith({  String? br,
  String? etd,
  String? fpod,
  String? blact,
  String? blno,
  ...
  String? sailing,
  String? vessel,
}) => BlOfLadingOnReferesh(  br: br ?? _br,
  etd: etd ?? _etd,
  fpod: fpod ?? _fpod,
  blact: blact ?? _blact,
  blno: blno ?? _blno,
