...
class _ConsigneeDoSlipState extends State<ConsigneeDoSlip> {
  TextEditingController consigneeDoSlipFromDate = TextEditingController();
  TextEditingController consigneeDoSlipToDate = TextEditingController();
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          controller: consigneeDoSlipFromDate,
                          onTap: () async {
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              controller: consigneeDoSlipToDate,
                              onTap: () async {
                                DateTime? pickedDate = await showDatePicker(
                                    context: context,
                                    initialDate: DateTime.now(),
