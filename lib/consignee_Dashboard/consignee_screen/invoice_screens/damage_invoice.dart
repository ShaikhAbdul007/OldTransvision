...
class _DamageInvoiceState extends State<DamageInvoice> {
  TextEditingController damageInvoiceFromDate = TextEditingController();
  TextEditingController damageInvoiceToDate = TextEditingController();
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          controller: damageInvoiceFromDate,
                          onTap: () async {
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              controller: damageInvoiceToDate,
                              onTap: () async {
                                DateTime? pickedDate = await showDatePicker(
                                    context: context,
                                    initialDate: DateTime.now(),
